        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="header-title">Cadastro de Produto</h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('unidade_medida') is-invalid @enderror" id="unidade_medida" name="unidade_medida" required>
                                ...
                                @foreach($unidadesMedida as $key => $unidade)
                                    <option value="{{ $key }}" {{ old('unidade_medida', 'Unidade') == $key ? 'selected' : '' }}>
                                        {{ $unidade }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('descricao') is-invalid @enderror" 
                                      ...
                                      name="descricao" 
                                      rows="3" 
                                      placeholder="Descreva o produto detalhadamente">{{ old('descricao') }}</textarea>
                            @error('descricao')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-content-save"></i> Salvar Produto
                                </button>
                            </div>
                        </div>
                    </div>
