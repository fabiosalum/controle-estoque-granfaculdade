        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="header-title">Cadastro de Fornecedor</h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo">
                                ...
                                <option value="Distribuidor" {{ old('tipo') == 'Distribuidor' ? 'selected' : '' }}>Distribuidor</option>
                                <option value="Fabricante" {{ old('tipo') == 'Fabricante' ? 'selected' : '' }}>Fabricante</option>
                                <option value="Importador" {{ old('tipo') == 'Importador' ? 'selected' : '' }}>Importador</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('estado') is-invalid @enderror" id="estado" name="estado">
                                ...
                                @foreach($estados as $uf => $nome)
                                    <option value="{{ $uf }}" {{ old('estado') == $uf ? 'selected' : '' }}>
                                        {{ $nome }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('observacoes') is-invalid @enderror" 
                                      ...
                                      name="observacoes" 
                                      rows="3" 
                                      placeholder="Informações adicionais sobre o fornecedor">{{ old('observacoes') }}</textarea>
                            @error('observacoes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-content-save"></i> Salvar Fornecedor
                                </button>
                            </div>
                        </div>
                    </div>
